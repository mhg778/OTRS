...
$Self->{'CustomerPreferencesGroups'}->{'SkinOptions'} =  {
  'Active' => '1',
  'Area' => 'Customer',
  'Desc' => 'Select configuration options of the selected skin.',
  'Key' => '',
  'Label' => 'Skin Options',
  'Module' => 'Kernel::Output::HTML::Preferences::SkinOptions',
  'PrefKey' => 'UserSkinOptions',
  'PreferenceGroup' => 'UserProfile',
  'Prio' => '2000'
};
...
$Self->{'Frontend::Module'}->{'AdminOAuth2TokenConfig'} =  {
  'Description' => '',
  'Group' => [
    'admin'
  ],
  'GroupRo' => [],
  'NavBarName' => 'AdminOAuth2TokenConfig',
  'Title' => 'OAuth2 Configuration Management'
};
...
$Self->{'Frontend::Module'}->{'AdminUpdate'} =  {
  'Description' => 'This module is part of the admin area of OTRS.',
  'Group' => [
    'admin'
  ],
...
$Self->{'Frontend::NavigationModule'}->{'AdminOAuth2TokenConfig'} =  {
  'Block' => 'Communication',
  'Description' => 'Manage OAuth2 tokens and configuration.',
  'Group' => [
    'admin'
  ],
  'GroupRo' => [],
...
delete $Self->{'Frontend::NotifyModule'}->{'1000-CloudServicesDisabled'};
...
$Self->{'Frontend::RichText::DefaultCSS'} =  'font-family:Geneva,Helvetica,Arial,sans-serif; font-size: 12pt;';
...
$Self->{'Loader::Agent::DefaultSkin::UseModern'} =  0;
...
$Self->{'Loader::Customer::DefaultSkin::UseModern'} =  0;
...
$Self->{'Loader::Module::AdminOAuth2TokenConfig'}->{'001-Framework'} =  {
  'JavaScript' => [
    'Core.Agent.Admin.AdminOAuth2TokenConfig.js'
  ]
};
...
$Self->{'Loader::Module::AdminPriority'}->{'001-Framework'} =  {
  'CSS' => [
    'Core.AppointmentCalendar.Manage.css',
    'thirdparty/spectrum-1.8.1/spectrum.css'
  ],
...
$Self->{'PreferencesGroups'}->{'SkinOptions'} =  {
  'Active' => '1',
  'Area' => 'Agent',
  'Desc' => 'Select configuration options of the selected skin.',
  'Key' => '',
...
$Self->{'SendmailModule::AuthenticationMethod'} =  'password';
